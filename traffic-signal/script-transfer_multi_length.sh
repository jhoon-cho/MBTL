...
#SBATCH -o logs/multitransfer_length/output-%j.log
#SBATCH --job-name=multitransfer_length
...
RESULT_PATH="/home/gridsan/xxxx/xxxx/traffic-signal/results/intersection_flow1000_lane4_lengthmulti_speed14.0_left0.25_algDQN_trial${TRIAL}/transfer/intersection_flow${VAR2}_lane4_length750.0_speed14.0_left0.25_algDQN_trial${TRIAL}/transfer_results_1.csv"
if [ ! -f "$RESULT_PATH" ]; then
    ...
    python -u transfer_main.py \
        ...
        --left 0.25 \
        --model_num 2 \
        --source_path_name "intersection_flow1000_lane4_lengthmulti_speed14.0_left0.25_algDQN_trial$TRIAL/" \
        --num_episodes 50 \
        --trial $TRIAL \
        --alg DQN
else
